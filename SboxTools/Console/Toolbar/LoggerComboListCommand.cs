...
namespace SboxTools.Console.Toolbar
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class LoggerComboListCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private LoggerComboListCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static LoggerComboListCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new LoggerComboListCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                Marshal.GetNativeVariantForObject(new[] { "All" }.Concat(ConsoleWindow.Instance.Logs.Loggers).ToArray(), oOleMenuCmdEventArgs.OutValue);
            }
        }
    }
}
