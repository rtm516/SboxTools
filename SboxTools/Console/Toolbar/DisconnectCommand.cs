...
namespace SboxTools.Console.Toolbar
{
    ...
    internal sealed class DisconnectCommand
    {
        ...
        private DisconnectCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static DisconnectCommand Instance
        {
            get;
            private set;
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            ConsoleWindow.Instance.Disconnect();
        }
